...
# input_anchor, input_positive, input_negative = input_anchor.type(torch.DoubleTensor), input_positive.type(torch.DoubleTensor), input_negative.type(torch.DoubleTensor)
